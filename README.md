...
| <a name="requirement_utility"></a> [utility](#requirement\_utility) | 0.3.0 |
...
| [utility_file_downloader.lambda_release](https://registry.terraform.io/providers/frontiersgg/utility/0.3.0/docs/resources/file_downloader) | resource |
...
| <a name="input_lambda_package_version"></a> [lambda\_package\_version](#input\_lambda\_package\_version) | The version of the Lambda package/artifact released separately from this module at https://github.com/rockholla/terraform-aws-lambda-eks-apply/releases | `string` | `"v0.0.1"` | no |
